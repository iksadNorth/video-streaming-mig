...
from src.model import Comment, Users, Video
from sqlalchemy.orm import Session


def register_video(db: Session):
    publisher = Users(email='ROSÉ@noexist.com', nickname='ROSÉ', bedge_src='https://yt3.ggpht.com/qjsflFmyakGs5ekX8fPsDNfuKABx-yxIDrv-4ooPAFcZ6JUUpUPlue7g_d-VAk2YAiYR-0yr=s48-c-k-c0x00ffffff-no-rj')
...
''',
    ...
    video = Video(
        title='test', 
        file_path='9202/src.mp4',
        thumbnail_path='9202/thumbnail_0.jpg',
        # publisher=publisher, 
        # comments=comments, 
    )
